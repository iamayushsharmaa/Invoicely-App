...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<InvoiceEntity> invoices) : _invoices = invoices;
...
/// @nodoc
abstract class _$$SingleInvoiceLoadedImplCopyWith<$Res> {
  factory _$$SingleInvoiceLoadedImplCopyWith(_$SingleInvoiceLoadedImpl value,
          $Res Function(_$SingleInvoiceLoadedImpl) then) =
      __$$SingleInvoiceLoadedImplCopyWithImpl<$Res>;
  @useResult
  $Res call({InvoiceEntity? invoice});
}

/// @nodoc
class __$$SingleInvoiceLoadedImplCopyWithImpl<$Res>
    extends _$InvoiceStateCopyWithImpl<$Res, _$SingleInvoiceLoadedImpl>
    implements _$$SingleInvoiceLoadedImplCopyWith<$Res> {
  __$$SingleInvoiceLoadedImplCopyWithImpl(_$SingleInvoiceLoadedImpl _value,
  ...
  $Res call({
    ...
    return _then(_$SingleInvoiceLoadedImpl(
      freezed == invoice
          ? _value.invoice
...
class _$SingleInvoiceLoadedImpl implements _SingleInvoiceLoaded {
  const _$SingleInvoiceLoadedImpl(this.invoice);
  ...
  @override
  String toString() {
    return 'InvoiceState.singleInvoiceLoaded(invoice: $invoice)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$SingleInvoiceLoadedImpl &&
  ...
  _$$SingleInvoiceLoadedImplCopyWith<_$SingleInvoiceLoadedImpl> get copyWith =>
      __$$SingleInvoiceLoadedImplCopyWithImpl<_$SingleInvoiceLoadedImpl>(
          this, _$identity);
...
abstract class _SingleInvoiceLoaded implements InvoiceState {
  const factory _SingleInvoiceLoaded(final InvoiceEntity? invoice) =
